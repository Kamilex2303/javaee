...
<form action="add-form">
    ...
    <input type="text" name="name" id="name" required="required" value="${sess_form.name}"><br>

    <label for="from">Od daty:</label>
    <input type="text" name="from" id="from" required="required" value="${sess_form.from}"><br>

    <label for="to">Do daty:</label>
    <input type="text" name="to" id="to" required="required" value="${sess_form.to}"><br>
